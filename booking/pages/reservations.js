...
(function () {
  ...
  const _css = `
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .res-form-input:focus,.res-form-select:focus { outline:none; background:var(--card-hover); border-color:var(--accent); box-shadow:0 0 0 3px rgba(var(--accent-rgb),0.13); }
    ...
    .csd-input:focus { background:var(--card-hover); border-color:var(--accent); box-shadow:0 0 0 3px rgba(var(--accent-rgb),0.13); }
